...
//		this.distance =
	...
	private int getDistance(Vertex<K> node, Vertex<K> target) {return 0;}
	private SimpleList<Vertex<K>> getNeighbors(Vertex<K> node) {return null;}
	private SimpleList<Vertex<K>> getMinimum(SimpleList<Vertex> nodes){return null;}
	private boolean isSettled(Vertex node) {return this._ProcessedNodes.exists(node);}
	private int getShortestDistance(Vertex<K> destination){return 0;}
	public SimpleList<Vertex<K>> getPath(Vertex target){return null;} 
}
